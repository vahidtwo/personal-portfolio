...
_USER_HOLDING_COLUMNS = (
    ...
    ("coin_emami", "NUMERIC(20, 8) NOT NULL DEFAULT 0"),
    ("coin_bahar", "NUMERIC(20, 8) NOT NULL DEFAULT 0"),
    ("coin_half", "NUMERIC(20, 8) NOT NULL DEFAULT 0"),
    ("coin_quarter", "NUMERIC(20, 8) NOT NULL DEFAULT 0"),
